    ...
    if (doesEvent.id !== undefined) {
      ...
      if (doesUser.status) {
        ...
        try {
          ...
          console.error(error);
          result = { status: false, error: 'Failed to insert player into leaderboard!', msg: null };
        }
      }
    } else {
      result = {
...
export const deleteLeaderBoardByEventID = async (
  ...
  try {
    ...
    console.error(error);
    result = { status: false, error: 'Failed to delete leaderboard in database', msg: null };
  }
...
export const updateUserPoints = async (
  ...
  try {
    ...
    console.error(error);
    result = { status: false, error: 'Failed to update leaderboard', msg: null };
  }
...
export const countUserInEvent = async (eventID: string): Promise<Result> => {
  ...
  try {
    ...
    console.error(error);
    result = { status: false, error: 'Failed to count players in leaderboard', msg: 0 };
  }
